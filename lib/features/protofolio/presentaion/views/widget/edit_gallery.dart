...
class _EditImageGalleryWidgetState
    extends State<EditPortofolioImageGalleryWidget> {
  late ImageBloc _imageBloc;
  List<PhotoDtO> photos = [];
  @override
  void dispose() {
    widget.selectedPhotos.isNotEmpty ? widget.selectedPhotos.clear() : null;
    photos.clear();
    super.dispose();
  }
